...
namespace AIB.Data.Migrations
{
    ...
    [Migration("20230220223206_44444444444")]
    partial class _44444444444
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AIB.Data.Entities.ExtendedRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "2b036899-9ada-4120-a6fe-0876c0670250",
                            Name = "Admin",
            ...
            modelBuilder.Entity("AIB.Data.Entities.ExtendedUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "a18be9c0-aa65-4af8-bd17-00bd9344e575",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "706964f1-caa5-4cd9-8adb-ef5ffe2d6fc2",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEJOjXD1YSu4LK85mYbDqCHF4S/hSxiG+Ql2MvYmUuyswG5yDebWFhlLkjFdymYK+lg==",
            ...
            modelBuilder.Entity("AIB.Data.Entities.Agent", b =>
                {
                    ...
                    b.HasOne("AIB.Data.Entities.ExtendedUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("AIB.Data.Entities.ExtendedUser", b =>
                {
                    b.HasOne("AIB.Data.Entities.ExtendedUser", "Manager")
                        .WithMany("Managers")
