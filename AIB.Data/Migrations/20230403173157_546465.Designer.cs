...
namespace AIB.Data.Migrations
{
    ...
    [Migration("20230403173157_546465")]
    partial class _546465
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AIB.Data.Entities.Branch", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AIB.Data.Entities.ExtendedRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "faf9af4c-747e-4a38-91e3-125a289f8c7f",
                            Name = "Admin",
            ...
            modelBuilder.Entity("AIB.Data.Entities.ExtendedUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "a18be9c0-aa65-4af8-bd17-00bd9344e575",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "d22f5bcc-52bb-4a86-bac3-0f665ac981d7",
                            Email = "scb_admin@sabaharains.com",
                            EmailConfirmed = true,
                            FirstName = "scb_admin@sabaharains.com",
                            Gender = 1,
                            LockoutEnabled = false,
                            MarriageStatus = 1,
                            NormalizedEmail = "scb_admin@sabaharains.com",
                            NormalizedUserName = "scb_admin@sabaharains.com",
                            PasswordHash = "AQAAAAEAACcQAAAAEEsgot2ZCBJ7VAKekyKQjApTqLqGJYJRFOi/N62W9ZfCbXUCMCleNcDvNMMav03N7A==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "",
                            TwoFactorEnabled = false,
                            TypeOfUser = 2,
                            UserName = "scb_admin@sabaharains.com",
                            isAgent = false,
                            isManager = false
                        });
                });
            ...
            modelBuilder.Entity("AIB.Data.Entities.Agent", b =>
                {
                    b.HasOne("AIB.Data.Entities.Branch", "Branch")
                        .WithMany("Agents")
